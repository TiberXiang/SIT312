...
param1 = {'value1':"Warning, the number of people is more than 3, please keep 1.5m distance of each person!"}

#create two more two sequences to store the name of vip visitor and verfied name 
vip_names = ['VipVisitor1', 'VipVisitor2']
...
while True:
    ...
    if len(CustomerList)>=3:    
        requests.get(url, data=param1, headers=headers)
    ...
    cv2.imshow("Face Overwatch", frame)
